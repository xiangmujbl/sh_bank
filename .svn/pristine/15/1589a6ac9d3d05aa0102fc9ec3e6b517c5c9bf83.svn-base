...
/**
 * Servlet implementation class createContractTest
 */
public class CreateContractTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CreateContractTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String customsId = request.getParameter("customsId");
		...
		//String endpoint="http://192.168.10.90:8180/mmecserver3.0_new_local/webservice/Common?wsdl";
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","createContract");
        OMElement eleData = fac.createOMElement("createContract", omNs);
        //对应参数的节点
...
//			call.setTargetEndpointAddress(new java.net.URL(GlobalUtil.endpoint));
//			call.setOperationName(new QName("http://wsdl.com/", "createContract"));
//
...
//
//			String result = call.invoke(new Object[] { appId, time, sign, signType, userId, customsId, templateId,
//					orderId, title, offerTime, data }).toString();
//			System.out.println(result);
//			request.getSession().setAttribute("result", result);
//			response.sendRedirect("jsp/result.jsp");// 跳转至结果页
