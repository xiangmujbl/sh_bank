...
<body>
<form action="<%=request.getContextPath() %>/ftpDownloadTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">FTP下载合同接口演示</th>
    </tr>
    </thead>
    <tbody>
	...
	<tr id="orderListTr">
      <td>orderList</td>
      <td>接入系统业务流水号,请以["orderid001","orderid002"]形式填写数据</td>
      <td><input type="text" id="orderList" name="orderList"  size="50" value="" /></td>
    </tr>
