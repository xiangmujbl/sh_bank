...
<body>
<form id="form4" name="form4" method="post" action="bangdingCertTest2.jsp">
<table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">绑定硬件证书接口演示</th>
    </tr>
    </thead>
    <tbody>
   ...
   <tr id="userIdTr">
    ...
    <tr id="certificateSerialIdTr">
      <td>certificateSerialId</td>
      <td>接入证书序列号</td>
      <td><input type="text" id="certificateSerialId" name="certificateSerialId" value="" size="50" /></td>
    </tr>
    <tr id="app_keyTr">
      <td>appKey</td>
      <td></td>
      <td> <input type="text" name="app_key" id="app_key" value="" ></td>
      </tr>
