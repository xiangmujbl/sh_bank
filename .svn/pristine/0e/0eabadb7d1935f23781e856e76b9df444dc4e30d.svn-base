 ...
 */
public class SignByCodeTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SignByCodeTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//使用ServiceClient调用https的WebService
		        ...
		        //设置命名空间
		        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","signByCode");
		        OMElement eleData = fac.createOMElement("signByCode", omNs);
		        //对应参数的节点
		 ...
		 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId","orderId","validCode","sealId","certType" };
			...
			String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "signByCode", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "signByCode"));
//
