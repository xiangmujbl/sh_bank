...
public class ResultData implements org.apache.thrift.TBase<ResultData, ResultData._Fields>, java.io.Serializable, Cloneable, Comparable<ResultData> {
  ...
  public ResultData setDesc(String desc) {
    this.desc = desc;
    return this;
  }
  ...
  public ResultData setPojo(String pojo) {
    this.pojo = pojo;
    return this;
  }
