...
/**
 * Servlet implementation class SyncOperateStatusTest
 */
public class SyncOperateStatusTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SyncOperateStatusTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","syncOperateStatus");
        OMElement eleData = fac.createOMElement("syncOperateStatus", omNs);
        //对应参数的节点
        String[] strs = new String[] { "appId", "time", "sign", "signType", "syncType" };
        //参数值
        String[] val = new String[] { appId, time, sign, signType, syncType};
...
//			call.setOperationName(new QName("http://wsdl.com/", "syncOperateStatus"));
//
...
//			System.out.println("appId:"+appId+"time:"+time+"sign:"+sign+"signType:"+signType+"syncType:"+syncType);
//			String result = call.invoke(new Object[] { appId, time, sign, signType, syncType }).toString();
//			System.out.println(result);
//			request.getSession().setAttribute("result", result);
//			response.sendRedirect("jsp/result.jsp");// 跳转至结果页
