...
public class SignPdfTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","signPdf");
        OMElement eleData = fac.createOMElement("signPdf", omNs);
        //对应参数的节点
        ...
        while(iterator.hasNext()){
		 ...
		 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId","orderId","sealId","certType" };
			...
			String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "signPdf", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "signPdf"));
//
