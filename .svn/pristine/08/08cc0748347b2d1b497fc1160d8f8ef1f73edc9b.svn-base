 ...
 */
public class SignPdfByCodeTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SignPdfByCodeTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 参数装填
		map.put(request.getParameter("codeType"), request.getParameter("code"));

		String appId = request.getParameter("appId");
		String signType = request.getParameter("signType");
		String userId = request.getParameter("userId");
		String orderId = request.getParameter("orderId");
		String validCode = gson.toJson(map);
		...
		//使用ServiceClient调用https的WebService
		        ...
		        //设置命名空间
		        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","signPdfByCode");
		        OMElement eleData = fac.createOMElement("signPdfByCode", omNs);
		        //对应参数的节点
		        String[] strs = new String[] { "appId", "time", "sign", "signType", "userId","orderId","validCode","sealId","certType" };
		        //参数值
		        String[] val = new String[] { appId, time, sign, signType, userId, orderId, validCode, sealId, certType};
		 ...
		 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId","orderId","validCode","sealId","certType" };
		    
	        String[] paramValue = new String[] { appId, time, sign, signType, userId, orderId, validCode, sealId, certType};

			String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "signPdfByCode", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "signPdfByCode"));
//
...
//			call.addParameter("validCode", XMLType.XSD_STRING, ParameterMode.IN);
...
//
//			String result = call
//					.invoke(new Object[] { appId, time, sign, signType, userId, orderId, validCode, sealId, certType })
//					.toString();
//			System.out.println(result);
//			request.getSession().setAttribute("result", result);
//			response.sendRedirect("jsp/result.jsp");// 跳转至结果页
