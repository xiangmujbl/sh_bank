 ...
 */
public class UpdateUserAdminTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateUserAdminTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//使用ServiceClient调用https的WebService
		        ...
		        //设置命名空间
		        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","updateUserAdmin");
		        OMElement eleData = fac.createOMElement("updateUserAdmin", omNs);
		        //对应参数的节点
		        ...
		        */
		 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId" };
		    
	        String[] paramValue = new String[] {appId, time, sign, signType, userId};

			String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "updateUserAdmin", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "updateUserAdmin"));
//
