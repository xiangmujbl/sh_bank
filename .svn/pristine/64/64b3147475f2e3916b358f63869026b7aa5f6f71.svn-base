...
<body>
<form id="form4" name="form4" method="post" action="companyApprove2.jsp">
<table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">企业认证接口演示</th>
    </tr>
    </thead>
    <tbody>
   ...
   <tr id="companyNameTr">
      <td>companyName</td>
      <td>企业名称</td>
      <td><input type="text" id="company_name" name="company_name" value="" size="50" /></td>
    </tr>
    <tr id="businessLicenseNoTr">
      <td>businessLicenseNo</td>
      <td>统一社会信用代码</td>
      <td><input type="text" id="business_license_no" name="business_license_no" value="" size="50" /></td>
    </tr>
