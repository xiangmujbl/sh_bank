...
<body>
<form action="<%=request.getContextPath() %>/createContractWithFileTest" method="post" enctype="multipart/form-data">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">创建合同接口演示(有附件)</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr id="dataTr" >
      <td>data</td>
      <td>模板数据，请以{"参数名1":"值1",...,"参数名n":"值n"}形式填写数据，参数名为模板中对应参数名</td>
      <td><input type="text" id="data" name="data" value="" size="50" /></td>
    </tr>
