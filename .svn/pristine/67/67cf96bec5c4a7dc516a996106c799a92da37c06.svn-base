...
<body>
<form action="${pageContext.request.contextPath}/registerTest" method="post" enctype="multipart/form-data">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">注册接口演示</th>
    </tr>
    </thead>
    <tbody>
    ...
    <!-- <tr id="isMakeSealTr">
      <td>isMakeSeal</td>
      <td>是否自动生成图章(Y/N)</td>
      <td><input type="text" id="isMakeSeal" name="isMakeSeal" value="" size="50" /></td>
    </tr> -->
    <tr id="licenseNoTr">
      <td>licenseNo</td>
