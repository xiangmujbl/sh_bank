...
/**
 * Servlet implementation class CancelContractTest
 */
public class CancelContractTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CancelContractTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//使用ServiceClient调用https的WebService
		        ...
		        //设置命名空间
		        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","cancelContract");
		        OMElement eleData = fac.createOMElement("cancelContract", omNs);
		        //对应参数的节点
...
//			call.setOperationName(new QName("http://wsdl.com/", "cancelContract"));
//
