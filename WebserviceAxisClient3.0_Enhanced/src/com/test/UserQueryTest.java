...
public class UserQueryTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","userQuery");
        OMElement eleData = fac.createOMElement("userQuery", omNs);
        //对应参数的节点
...
//			call.setOperationName(new QName("http://wsdl.com/", "userQuery"));
//
...
//
//			String result = call.invoke(new Object[] { appId, time, sign, signType, userId }).toString();
//			System.out.println(result);
//			request.getSession().setAttribute("result", result);
//			response.sendRedirect("jsp/result.jsp");// 跳转至结果页
