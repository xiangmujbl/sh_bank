...
/**
 * Servlet implementation class SendValidateCodeTest
 */
public class SendValidateCodeTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SendValidateCodeTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","sendValidateCode");
        OMElement eleData = fac.createOMElement("sendValidateCode", omNs);
        //对应参数的节点
        String[] strs = new String[] { "appId", "time", "sign", "signType", "userId","orderId" };
        //参数值
        String[] val = new String[] {appId, time, sign, signType, userId, orderId};
	 ...
	 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId","orderId" };
	    
        String[] paramValue = new String[] {appId, time, sign, signType, userId, orderId};

		String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "sendValidateCode", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "sendValidateCode"));
//
...
//
//			String result = call.invoke(new Object[] { appId, time, sign, signType, userId, orderId }).toString();
//			System.out.println(result);
//			request.getSession().setAttribute("result", result);
//			response.sendRedirect("jsp/result.jsp");// 跳转至结果页
//
