...
public class SignPdfAllTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SignPdfAllTest() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //设置命名空间
        OMNamespace omNs = fac.createOMNamespace("http://wsdl.com/","signPdfAll");
        OMElement eleData = fac.createOMElement("signPdfAll", omNs);
        //对应参数的节点
        ...
        while(iterator.hasNext()){
		 ...
		 String[] paramName = new String[] { "appId", "time", "sign", "signType", "userId","orderId","sealId","certType" };
		    
	        String[] paramValue = new String[] {appId, time, sign, signType, userId, orderId, sealId, certType};

			String result = CallWebServiceUtil.CallHttpsService(endpoint, "http://wsdl.com/", "signPdfAll", paramName, paramValue);
...
//			call.setOperationName(new QName("http://wsdl.com/", "signPdfAll"));
//
