...
<body>
<form id="form4" name="form4" method="post" enctype="multipart/form-data" action="/WebserviceAxisClient3.0_Enhanced/authorityCreateByTemplate" >
<table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">授权管理接口演示</th>
    </tr>
    </thead>
    <tbody>
   ...
   <tr id="userIdTr">
    ...
    <tr id="customIdTr">
      <td>customId</td>
      <td>缔约方</td>
      <td><input type="text" id="customId" name="customId" value="" size="50" /></td>
    </tr>
    ...
    <tr>
      <td>authorUserId</td>
      <td>被授权方</td>
      <td><input name="authorUserId" type="text" value=""/></td>
    </tr>
    ...
    <tr>
      ...
      <td>授权期限</td>
      <td>
      	<input type="text" name="authorStartTime" id="authorStartTime"/> <span class="gray ml10">(例子：2017-5-30 10:38:37)</span>
      	<input type="text" name="authorEndTime" id="authorEndTime" /> <span class="gray ml10">(例子：2018-5-30 10:38:37)</span>
      </td>
    </tr>
    ...
    <tr id="templateIdTr">
      <td>templateId</td>
      <td>模板编号（可以为空）</td>
      <td><input type="text" id=templateId name="templateId" value=""/></td>
    </tr>
    
    <tr id="templateIdTr">
      <td>data </td>
      <td>模板数据 <span class="gray ml10">(例子：2017-5-30 10:38:37)</span></td>
