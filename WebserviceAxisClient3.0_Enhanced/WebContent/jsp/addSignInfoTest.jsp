...
<body>
<form action="<%=request.getContextPath() %>/addSignInfoTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">添加签名位置信息接口</th>
    </tr>
    </thead>
    <tbody>
...
<!-- 	<tr id="userIdTr">
	...
	<!-- <tr id="positionCharTr">
      <td>positionChar</td>
      <td>签名标识符</td>
      <td><input type="text" id="positionChar" name="positionChar" value="" size="50" /></td>
    </tr> -->
    <tr id="signInfoTr">
      <td>signInfo</td>
      <td>签署位置和信息，格式例如：[{"userId":"test_001","position":"1,3","signUiType":"1"},{"userId":"test_002","position":"2","signUiType":"2"}]</td>
      <td><input type="text" id="signInfo" name="signInfo" value="" size="50" /></td>
    </tr>
