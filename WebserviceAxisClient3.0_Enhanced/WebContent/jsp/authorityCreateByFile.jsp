...
<body>
<form id="form4" name="form4" method="post" enctype="multipart/form-data" action="/WebserviceAxisClient3.0_Enhanced/authorityCreateByFile" >
  ...
  <thead>
   ...
   <tr id="userIdTr">
    ...
    <tr>
      <td>fileInfo</td>
      <td>合同内容</td>
      <td><input type="file" name="fileInfo" id="fileupload"></td>
    </tr>
    
    <tr>
      <td>attachmentInfo</td>
      <td>附件内容1</td>
      <td><input type="file" name="attachmentInfo" id="fileupload"></td>
    </tr>
