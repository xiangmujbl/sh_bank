...
<body>
<form action="<%=request.getContextPath() %>/completeUserInformationTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">用户信息补全接口演示</th>
    </tr>
    </thead>
    <tbody>
...
<!--      <tr id="licenseNoTr">
      <td>bussinessLicenseNo</td>
      <td>公司营业执照号</td>
      <td><input type="text" id="bussinessLicenseNo" name="bussinessLicenseNo" value="" size="50" /></td>
    </tr>-->
<!--    <tr id="companyNameTr">
      <td>companyName</td>
      <td>公司名称</td>
