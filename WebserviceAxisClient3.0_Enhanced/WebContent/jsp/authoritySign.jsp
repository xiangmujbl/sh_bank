...
<body>
<form action="<%=request.getContextPath() %>/authoritySignTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">签署接口演示（授权自动代签）</th>
    </tr>
    </thead>
    <tbody>
	...
	<tr id="sealNumTr">
      ...
      <td><input type="text" id="sealNum" name="sealNum" value="" size="50" /></td>
    </tr>
    <tr id="certTypeTr">
      <td>certType</td>
