...
<body>
<form id="form4" name="form4" method="post" action="httpDownloadTest2.jsp">
<table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">HTTP下载合同接口演示</th>
    </tr>
    </thead>
    <tbody>
   ...
   <tr id="userIdTr">
    ...
    <tr id="isPdfTr">
      <td>isPdf</td>
      <td>pdf下载填：pdf</td>
      <td><input type="text" id="isPdf" name="isPdf" value="" size="50" /></td>
    </tr>
