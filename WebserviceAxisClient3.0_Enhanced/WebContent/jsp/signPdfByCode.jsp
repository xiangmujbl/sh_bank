...
<body>
<form action="<%=request.getContextPath() %>/signPdfByCodeTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">pdf签署接口演示（带短信验证码或密码）</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr id="codeTr">
      <td>code</td>
      <td>验证码选择：SMS：短信验证码；PWD：密码</td>
      <td>
      	  <select id="codeType" name="codeType">
      		<option value="SMS">短信验证码</option>
      		<option value="PWD">密码</option>
      	  </select>
          <input type="text" id="code" name="code" value="" size="50"/>
      </td>
    </tr>
	<tr id="sealIdTr">
      <td>sealId</td>
      <td>图章编号，例如：123456789</td>
      <td><input type="text" id="sealId" name="sealId" value="" size="50" /></td>
    </tr>
    <tr id="certTypeTr">
      <td>certType</td>
