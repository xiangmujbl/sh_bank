...
<body>
<form action="<%=request.getContextPath() %>/registerWithCheckIdcard" method="post" enctype="multipart/form-data">
  ...
  <thead>
    ...
    <tr id="cardNumTr">
      <td>cardNum</td>
      <td>证件号码</td>
      <td><input type="text" id="cardNum" name="cardNum" value="" size="50" /></td>
    </tr>
    <tr id="mobileTr">
      <td>mobile</td>
      <td>电话</td>
