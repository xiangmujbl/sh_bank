...
<body>
<form action="<%=request.getContextPath() %>/createContractTest" method="post">
  <table class="data-box" width="80%" >
  <thead>
    <tr id="proTr">
      <th colspan="3">创建合同接口演示</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr id="templateIdTr" >
      <td>templateId</td>
      <td>合同编号</td>
      <td><input type="text" id="templateId" name="templateId" value="" size="50" /></td>
    </tr>
    <tr id="dataTr" >
      <td>data</td>
